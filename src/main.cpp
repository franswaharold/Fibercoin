...
unsigned int nTargetSpacing = 1 * 114;
...
unsigned int nModifierInterval = 7 * 60;
...
const string strMessageFibercoin = "Fibercoin Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Fibercoin: check proof-of-stake block signature
...
// Fibercoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Fibercoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // MainNet:
        //block.GetHash() == 00000613e6d91f5f8da3dd884d8c7d34eed6a54662afdf5013e9b74ba9c7e248
        //block.hashMerkleRoot == 01adece16ac26020dc727a6d9505776d220074b993649e4c7610dfd68c24f987
        //block.nTime =  1550664632
        //block.nNonce = 1322297

        const char* pszTimestamp = "Fibercoin for world economy 2019";
        CTransaction txNew;
        txNew.nTime = 1550664632;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 1322297 : 0;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x01adece16ac26020dc727a6d9505776d220074b993649e4c7610dfd68c24f987"));
